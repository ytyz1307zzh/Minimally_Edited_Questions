...
from ..data.retriever_data import TableChunk
from ..utils.tokenizers import SimpleTokenizer

logger = logging.getLogger(__name__)

QAMatchStats = collections.namedtuple("QAMatchStats", ["top_k_hits", "questions_doc_hits", "mean_reciprocal_rank"])
...
def calculate_matches(
    ...
    for question_hits in scores:
        ...
        if best_hit is not None:
            ...
            mean_reciprocal_rank.append(1/(best_hit+1))
        else:
            mean_reciprocal_rank.append(1/n_docs)
    return QAMatchStats(top_k_hits, scores, np.mean(mean_reciprocal_rank))
